export default function Home() {
  return (
    <div className="container">
      ...
      <h1 className="brand">Hourlyplace</h1>
      ...
      <div className="social-links">
        <a
          href="https://github.com/kswtechzone"
          target="_blank"
        ...
        <a
          href="https://twitter.com/kswtechzone"
          target="_blank"
          rel="noopener noreferrer"
          className="social-link"
        ...
        <a
          href="https://linkedin.com/company/kswtechzone"
          target="_blank"
          rel="noopener noreferrer"
          className="social-link"
          aria-label="LinkedIn"
      ...
      <p className="footer">
        Developed by <strong>KSW Techzone, Nepal</strong>
      </p>
    </div>
  );
}
